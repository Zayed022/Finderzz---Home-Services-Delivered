...
const actions = [
  ...
  { title: 'Delete Banner', path: '/banner/delete' },
  { title: 'Manage Banner', path: '/banner/manage' },
...
const Banner = () => {
  ...
  return (
    <div className="p-8 w-full">
      <h1 className="text-3xl font-semibold text-gray-800 mb-8">Banner Management</h1>
