...
const actions = [
  ...
  { title: 'Manage Bookings', path: '/bookings/manage' },
  { title: 'Get Booking by Id', path: '/bookings/id' },
...
const Bookings = () => {
  ...
  return (
    <div className="p-8 w-full">
      <h1 className="text-3xl font-semibold text-gray-800 mb-8">Booking Management</h1>
