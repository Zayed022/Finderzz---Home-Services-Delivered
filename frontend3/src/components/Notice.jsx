...
const actions = [
  ...
  { title: 'Add Notice', path: '/notice/add' },
  { title: 'All Notice', path: '/notice/all' },
  { title: 'Edit Notice', path: '/notice/edit' },
...
const Notice = () => {
  ...
  return (
    <div className="p-8 w-full">
      <h1 className="text-3xl font-semibold text-gray-800 mb-8">Area Management</h1>
