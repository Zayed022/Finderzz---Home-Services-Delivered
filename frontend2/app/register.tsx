  ...
  return(
    ...
    >
      ...
      <View style={styles.card}>
        ...
        {profileImage && (
          <Image source={{uri:profileImage.uri}} style={styles.preview}/>
        )}
        ...
        {aadhaarImage && (
          <Image source={{uri:aadhaarImage.uri}} style={styles.preview}/>
        )}
        ...
        {panImage && (
          <Image source={{uri:panImage.uri}} style={styles.preview}/>
        )}
